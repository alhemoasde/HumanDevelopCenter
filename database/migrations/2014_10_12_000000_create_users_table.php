...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('profile', 50)->comment('Perfil asignado en el sistema. Cliente, Admin o Speaker');
            $table->string('web', 100)->nullable()->comment('Nombre del sitio web del usuario, aplica solo conferencistas.');
            ...
            $table->string('biografhy', 2000)->nullable()->comment('Biografía del usuario conferencista.');
            $table->string('photography', 100)->nullable()->comment('Url de acceso a la fotografia del usuario.');
            $table->boolean('status')->default(true)->comment('Estado del Usuario 0= inactivo 1 = Activo');
            $table->timestamps();
