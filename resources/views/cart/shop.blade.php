                ...
                <div class="col-lg-12">
                    <ul class="nav nav-tabs" id="tabProduct" role="tablist">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="dia1" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="col-lg-3">
...
@foreach ($products as $pro)
    ...
    <br>
        <div class="card" style="margin-bottom: 20px; height: auto;">
            ...
            <div class="card-body">
                <a href="">
                    <h4 class="card-title h5">{{ $pro->name }}</h4>
                </a>
...
@endforeach
                                    ...
                                    <div class="tab-pane fade" id="dia2" role="tabpanel" aria-labelledby="profile-tab">Contenido dia 2</div>
                                    <div class="tab-pane fade" id="dia3" role="tabpanel" aria-labelledby="contact-tab">Contenido dia 3</div>
                                    <div class="tab-pane fade" id="dia4" role="tabpanel" aria-labelledby="contact-tab">Contenido dia 4</div>
                                    <div class="tab-pane fade" id="dia5" role="tabpanel" aria-labelledby="contact-tab">Contenido dia 5</div>
                                </div>
                </div>
                <!-- <div class="col-lg-3">
