    ...
    <section id="login" class="section-bg">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">{{ __('DATOS DE LA COMPAÑIA') }}</div>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('bussiness.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="aboutUs" rows="2"
                                            class="form-control @error('aboutUs') is-invalid @enderror" name="aboutUs"
                                            autocomplete="aboutUs" autofocus>{{ old('aboutUs') }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="mission" rows="2"
                                            class="form-control @error('mission') is-invalid @enderror" name="mission"
                                            autocomplete="mission" autofocus>{{ old('mission') }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="vision" rows="2"
                                            class="form-control @error('vision') is-invalid @enderror" name="vision"
                                            autocomplete="vision" autofocus>{{ old('vision') }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="accountTwitter" type="text"
                                            class="form-control @error('accountTwitter') is-invalid @enderror" name="accountTwitter"
                                            value="{{ old('accountTwitter') }}" autocomplete="accountTwitter" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="accountFacabook" type="text"
                                            class="form-control @error('accountFacabook') is-invalid @enderror" name="accountFacabook"
                                            value="{{ old('accountFacabook') }}" autocomplete="accountFacabook" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="accountInstagram" type="text"
                                            class="form-control @error('accountInstagram') is-invalid @enderror" name="accountInstagram"
                                            value="{{ old('accountInstagram') }}" autocomplete="accountInstagram" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="accountLinkedin" type="text"
                                            class="form-control @error('accountLinkedin') is-invalid @enderror" name="accountLinkedin"
                                            value="{{ old('accountLinkedin') }}" autocomplete="accountLinkedin" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="motto" type="text"
                                            ...
                                            value="{{ old('motto') }}" autocomplete="motto" autofocus>
                                ...
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="bi bi-send-check-fill"> {{ __('Guardar Datos') }} </i>
                                        </button>
                                    </div>
                                </div>
                            </form>
